...
ClockWise is a web-based application designed to streamline **Daily Time Record (DTR)** tracking and **Leave Management** for employees.  
...
- **Daily Time Record (DTR)**
  ...
  - Handle overtime and undertime calculations
