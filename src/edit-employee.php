...
// In production, fetch employee data from database
...
<head>
    ...
    <title>Edit Employee - ClockWise</title>
    ...
    <div class="form-page-container">
        ...
        <div class="form-card">
            <div class="form-card-header">
                <h1 class="form-card-title">✏️ Edit Employee</h1>
                <p class="form-card-subtitle">Update employee information</p>
            </div>
            ...
            <form method="POST" action="edit-employee.php?id=<?= $employeeId ?>">
                    ...
                    <div class="form-group">
                        ...
                        <select name="role" class="form-select" required>
                            <?php foreach ($roles as $value => $label): ?>
                                <option value="<?= $value ?>" <?= ($_POST['role'] ?? $employee['role']) == $value ? 'selected' : '' ?>>
                                    <?= $label ?>
                                </option>
                            <?php endforeach; ?>
                        </select>
                        ...
                        <div class="form-group">
                            ...
                            <select name="department" class="form-select" required>
                                ...
                                <?php foreach ($departments as $dept): ?>
                                    <option value="<?= $dept ?>" <?= ($_POST['department'] ?? $employee['department']) == $dept ? 'selected' : '' ?>>
                                        <?= $dept ?>
                                    </option>
                                <?php endforeach; ?>
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select name="work_group" class="form-select" required>
                                ...
                                <?php foreach ($workGroups as $group): ?>
                                    <option value="<?= $group ?>" <?= ($_POST['work_group'] ?? $employee['work_group']) == $group ? 'selected' : '' ?>>
                                        <?= $group ?>
                                    </option>
                                <?php endforeach; ?>
                            </select>
                    ...
                    <div class="form-group">
                        ...
                        <select name="shift" class="form-select" required>
                            ...
                            <?php foreach ($shifts as $shiftOption): ?>
                                <option value="<?= $shiftOption ?>" <?= ($_POST['shift'] ?? $employee['shift']) == $shiftOption ? 'selected' : '' ?>>
                                    <?= $shiftOption ?>
                                </option>
                            <?php endforeach; ?>
                        </select>
