...
@pytest.mark.a11y
async def test_admin_dashboard_overview(page, base_url, credentials):
    await login_as_admin(page, base_url, credentials)
    await page.wait_for_timeout(500)
    await run_axe_scan(page, "Admin Dashboard — Overview")
...
@pytest.mark.a11y
async def test_admin_dashboard_employees(page, base_url, credentials):
    await login_as_admin(page, base_url, credentials)
    await page.click("a[href='#employees']")
    await page.wait_for_selector("#employees.active", state="visible")
    await page.wait_for_timeout(500)
    await run_axe_scan(page, "Admin Dashboard — Employee Management")
...
@pytest.mark.a11y
async def test_admin_dashboard_approvals_setup(page, base_url, credentials):
    await login_as_admin(page, base_url, credentials)
    await page.click("a[href='#approvals_setup']")
    await page.wait_for_selector("#approvals_setup.active", state="visible")
    await page.wait_for_timeout(500)
    await run_axe_scan(page, "Admin Dashboard — Approvals Setup")
...
@pytest.mark.a11y
async def test_admin_dashboard_dtr_requests(page, base_url, credentials):
    await login_as_admin(page, base_url, credentials)
    await page.click("a[href='#dtr']")
    await page.wait_for_selector("#dtr.active", state="visible")
    await page.wait_for_timeout(500)
    await run_axe_scan(page, "Admin Dashboard — DTR Requests")
...
@pytest.mark.a11y
async def test_admin_dashboard_leave_requests(page, base_url, credentials):
    await login_as_admin(page, base_url, credentials)
    await page.click("a[href='#leave_requests']")
    await page.wait_for_selector("#leave_requests.active", state="visible")
    await page.wait_for_timeout(500)
    await run_axe_scan(page, "Admin Dashboard — Leave Requests")
...
@pytest.mark.a11y
async def test_admin_dashboard_leave_types(page, base_url, credentials):
    await login_as_admin(page, base_url, credentials)
    await page.click("a[href='#leave_types']")
    await page.wait_for_selector("#leave_types.active", state="visible")
    await page.wait_for_timeout(500)
    await run_axe_scan(page, "Admin Dashboard — Leave Types")
...
@pytest.mark.a11y
async def test_admin_dashboard_shifts(page, base_url, credentials):
    await login_as_admin(page, base_url, credentials)
    await page.click("a[href='#shifts']")
    await page.wait_for_selector("#shifts.active", state="visible")
    await page.wait_for_timeout(500)
    await run_axe_scan(page, "Admin Dashboard — Shift Schedules")
...
@pytest.mark.a11y
async def test_admin_dashboard_departments(page, base_url, credentials):
    await login_as_admin(page, base_url, credentials)
    await page.click("a[href='#departments']")
    await page.wait_for_selector("#departments.active", state="visible")
    await page.wait_for_timeout(500)
    await run_axe_scan(page, "Admin Dashboard — Departments")
...
@pytest.mark.a11y
async def test_admin_dashboard_work_groups(page, base_url, credentials):
    await login_as_admin(page, base_url, credentials)
    await page.click("a[href='#work_groups']")
    await page.wait_for_selector("#work_groups.active", state="visible")
    await page.wait_for_timeout(500)
    await run_axe_scan(page, "Admin Dashboard — Work Groups")
...
@pytest.mark.a11y
async def test_admin_dashboard_reports(page, base_url, credentials):
    await login_as_admin(page, base_url, credentials)
    await page.click("a[href='#reports']")
    await page.wait_for_selector("#reports.active", state="visible")
    await page.wait_for_timeout(500)
    await run_axe_scan(page, "Admin Dashboard — Reports")