...
def cleanup_auto_approved_leave(credentials, test_leave_date, request):
    """
    Teardown fixture for auto-approved leave submissions (e.g. Administrative group).
    ...
    Usage in test:
        def test_something(page, ..., cleanup_auto_approved_leave):
            cleanup_auto_approved_leave("administrative")   ← pass the credentials key
    """
...
def test_file_vl_submission_administrative_success(page, base_url, credentials, test_leave_date, cleanup_auto_approved_leave):
    ...
    administrative = credentials["administrative"]

    login(page, base_url, administrative["username"], administrative["password"])
    ...
    expect(page.get_by_role("note")).to_contain_text("✓ You are in the Administrative group. Your DTR and leave submissions are automatically approved.")
    ...
    page.screenshot(path=f"report/playwright_screenshots/leave_submission/administrative/vl_submitted_administrative_{test_leave_date}.png")
...
def test_file_sl_submission_administrative_success(page, base_url, credentials, test_leave_date, cleanup_auto_approved_leave):
    ...
    page.screenshot(path=f"report/playwright_screenshots/leave_submission/administrative/sl_submitted_administrative_{test_leave_date}.png")
...
def test_file_el_submission_administrative_success(page, base_url, credentials, test_leave_date, cleanup_auto_approved_leave):
    ...
    page.screenshot(path=f"report/playwright_screenshots/leave_submission/administrative/el_submitted_administrative_{test_leave_date}.png")
...
def test_file_nopay_submission_administrative_success(page, base_url, credentials, test_leave_date, cleanup_auto_approved_leave):
    ...
    page.screenshot(path=f"report/playwright_screenshots/leave_submission/administrative/nopay_submitted_administrative_{test_leave_date}.png")
...
def test_file_edu_submission_administrative_success(page, base_url, credentials, test_leave_date, cleanup_auto_approved_leave):
    ...
    page.screenshot(path=f"report/playwright_screenshots/leave_submission/administrative/edu_submitted_administrative_{test_leave_date}.png")
