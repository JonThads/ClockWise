...
@allure.title("Executive employee VL is automatically approved upon submission")
@allure.description("Verifies that the Vacation Leave option is automatically approved for Executive employees upon submission.")
@allure.severity(allure.severity_level.CRITICAL)
@allure.tag("leave", "VL", "executive", "auto-approved", "regression")
...
@allure.feature("Leave Management")
@allure.story("Auto-approved groups get instant approval")
@allure.title("Executive employee SL is automatically approved upon submission")
@allure.description("Verifies that the Sick Leave option is automatically approved for Executive employees upon submission.")
@allure.severity(allure.severity_level.CRITICAL)
@allure.tag("leave", "SL", "executive", "auto-approved", "regression")
...
@allure.feature("Leave Management")
@allure.story("Auto-approved groups get instant approval")
@allure.title("Executive employee EL is automatically approved upon submission")
@allure.description("Verifies that the Emergency Leave option is automatically approved for Executive employees upon submission.")
@allure.severity(allure.severity_level.CRITICAL)
@allure.tag("leave", "EL", "executive", "auto-approved", "regression")
...
@allure.feature("Leave Management")
@allure.story("Auto-approved groups get instant approval")
@allure.title("Executive employee NoPay is automatically approved upon submission")
@allure.description("Verifies that the Leave Without Pay option is automatically approved for Executive employees upon submission.")
@allure.severity(allure.severity_level.CRITICAL)
@allure.tag("leave", "NoPay", "executive", "auto-approved", "regression")
...
@allure.feature("Leave Management")
@allure.story("Auto-approved groups get instant approval")
@allure.title("Executive employee EDU is automatically approved upon submission")
@allure.description("Verifies that the Study Leave option is automatically approved for Executive employees upon submission.")
@allure.severity(allure.severity_level.CRITICAL)
@allure.tag("leave", "EDU", "executive", "auto-approved", "regression")
